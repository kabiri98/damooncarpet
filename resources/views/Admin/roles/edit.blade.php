...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="form-horizontal" action="{{ route('roles.update',[$role]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{method_field('PATCH')}}
@include('Admin.sections.errors')
            <div class="form-group ">
                <div class="col-sm-12 ">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="نام مقام را وارد کنید" value="{{ $role->name }}"">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="label" class="control-label">توضیحات</label>
                    <input type="text" class="form-control" name="label" id="label" placeholder="توضیحات این مقام  را وارد کنید" value="{{ $role->label }}">
                </div>
            </div>
